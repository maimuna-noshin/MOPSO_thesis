...
N_PV_optimal = round(paretoSolutions(:, 1)); % Optimal N_PV (rounded)
eta_system_optimal = paretoSolutions(:, 2);  % Optimal eta_system
disp('Optimal N_PV and eta_system:');
disp([N_PV_optimal, eta_system_optimal]);
end
